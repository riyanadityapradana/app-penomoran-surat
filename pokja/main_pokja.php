		...
		<div class="wrapper">
			...
			<nav class="main-header navbar navbar-expand navbar-white" style="background:#000000;">
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item d-none d-sm-inline-block"><a href="main_pokja.php?unit=beranda" class="nav-link">Home</a></li>
				</ul>
				<!-- Right navbar links -->
			...
			<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background:rgb(217, 221, 224, 1)">
				<!-- Brand Logo -->
				<a href="main_pokja.php?unit=beranda" class="brand-link" style="background:rgb(0, 0, 0, 1)">
				  ...
				  <!-- Sidebar user panel (optional) -->
					<div class="user-panel mt-3 pb-3 mb-3 d-flex">
						...
						<div class="info ml-2">
							...
							<span class="text-muted small">POKJA <?=strtoupper($_SESSION['kode_pokja']);?></span>
						</div>
					</div>
					<!-- SidebarSearch Form -->
						...
						<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						  <!-- Add icons to the links using the .nav-icon class with font-awesome or any other icon font library -->
							<li class="nav-item menu-open">
								<a href="main_pokja.php?unit=beranda" class="nav-link active">
									<i class="nav-icon fas fa-tachometer-alt" style="color: black;"></i><p style="color: black;">Dashboard</p>
								</a>
							</li>
							<li class="nav-item menu-open">
								<a href="main_pokja.php?unit=pengajuan" class="nav-link" style="background:rgb(231, 234, 232)">
									<i class="nav-icon fas fa-upload" style="color: black;"></i><p style="color: black;">Dokumen Ajuan</p>
								</a>
							</li>
							<li class="nav-item menu-open">
								<a href="main_pokja.php?unit=pengesahan" class="nav-link" style="background:rgb(231, 234, 232)">
									<i class="nav-icon fas fa-check" style="color: black;"></i><p style="color: black;">Dokumen Sah</p>
								</a>
							</li>
							<li class="nav-item menu-open">
								<a href="main_pokja.php?unit=rekap" class="nav-link" style="background:rgb(231, 234, 232)">
