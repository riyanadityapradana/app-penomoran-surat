<?php
	...
	if ($_SESSION['level'] != 'Kepala Ruangan') {
	...
	<body class="hold-transition sidebar-mini layout-fixed">
		<div class="wrapper">
			...
			<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background:rgb(217, 221, 224, 1)">
				<!-- Brand Logo -->
				<a href="main_admin.php?unit=beranda" class="brand-link" style="background:rgb(129, 2, 0, 1)">
					<img src="../assets/img/icon.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
					<span class="brand-text font-weight-light">ITUTL - RSPI</span>
				</a>
				<!-- Sidebar -->
				<div class="sidebar">
				  <!-- Sidebar user panel (optional) -->
					...
					<div class="info">
						<a href="#" class="d-block" style="color: black;">KEPALA RUANGAN IT</a>
					</div>
				</div>
					...
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
					  <!-- Add icons to the links using the .nav-icon class with font-awesome or any other icon font library -->
						<li class="nav-item menu-open">
							<a href="main_admin.php?unit=beranda" class="nav-link" style="background:rgb(231, 234, 232)">
						...
						<li class="nav-item">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="main_admin.php?unit=logbook" class="nav-link">
									...
									<a href="main_admin.php?unit=remote" class="nav-link">
									...
									<a href="main_admin.php?unit=penyerahan" class="nav-link">
										<i class="nav-icon fas fa-list-alt" style="color: black;"></i>
										<p style="font-size: 14px; color: black;">Data Pemakaian Barang</p>
									</a>
									<a href="main_admin.php?unit=perbaikan" class="nav-link">
										<i class="nav-icon fas fa-wrench" style="color: black;"></i>
										<p style="font-size: 14px; color: black;">Data Perbaikan Barang</p>
									</a>
								</li>
							</ul>
						</li>
			...
			<footer class="main-footer">
				<strong>Copyright &copy; 2025-2027 <a href="https://adminlte.io">ITUTL-RSPI.io</a>.</strong>
				All rights reserved.
