...
$tgl_filter = isset($_GET['tanggal_pengesahan']) ? $_GET['tanggal_pengesahan'] : '';
...
<body>
    ...
    <div class="info">
        ...
        Pokja: <?= $pokja_filter ? $pokja_filter : 'Semua' ?><br>
    </div>
    ...
    <div style="text-align:center; margin-top:20px;">
        <button onclick="window.print()" style="padding:10px 20px; background:#007b3e; color:#fff; border:none; border-radius:5px; cursor:pointer;">
